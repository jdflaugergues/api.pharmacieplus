...
const fs = require('fs'),
      _ = require('lodash'),
      async = require('async'),
      debug = require('debug')('pharmacieplus:importData'),
      lambert93toWGPS = require('./tools'),
      AbstractDAOFactory = require('../dao/abstractdaofactory');

'use strict';

// Echantillon de données pour les tests
...
structureet;010002301;010002293;PHARMACIE AA VOLLENWEIDER PATRICE;;;;41;R;ALEXANDRE BERARD;;BP 107;4;1;AIN;01500 AMBERIEU EN BUGEY;474350415;;620;Pharmacie d'Officine;3201;Commerce de Biens à Usage Médicaux;3,31254E+13;;1;Etablissement Tarif Libre;;;12/06/1989;07/04/1989;27/03/2007;
structureet;010002335;010002327;PHARMACIE BB DE FLAUGERGUESfff ;;;;625;AV;LEON BLUM;;;4;1;AIN;01500 AMBERIEU EN BUGEY;;;620;Pharmacie d'Officine;3201;Commerce de Biens à Usage Médicaux;4,09527E+13;;1;Etablissement Tarif Libre;;;02/07/2013;02/08/2012;17/11/2015;
structureet;010002350;010002343;PHARMACIE CC GUSTIN J-J.& GUSTIN M-CH.;;;;68;AV;ROGER SALENGRO;;;4;1;AIN;01500 AMBERIEU EN BUGEY;474468146;474380624;620;Pharmacie d'Officine;3201;Commerce de Biens à Usage Médicaux;3,40556E+13;;1;Etablissement Tarif Libre;;;20/09/1990;22/11/1985;05/09/2006;
...
// Path du fichier contenant les données des pharmacies
...
class ImportData {
    ...
    static readFile(fileName){
        ...
        debug(`Lecture du fichier ${fileName} de pharmacies.`);
    ...
    static parseData(data){
        ...
        debug(`Analyse des données des pharmacies.`);
        ...
        async.parallel({
            ...
            pharStruct.forEach((pharmacie, index) => {
                ...
                // Conversion des coordonnées Lambert 93 de la pharmacie en coordonnées GPS
                let wgps = lambert93toWGPS(parseFloat(_.find(pharGeoloc, (phar) => (phar[1] == pharmacie[1]) )[2]), parseFloat(_.find(pharGeoloc, (phar) => (phar[1] == pharmacie[1]) )[3]));
                ...
                listPharmacies.push({
                    ...
                    fax: pharmacie[17],
                    loc: [ wgps.longitude, wgps.latitude]
                });
            });
    ...
    static updateDb(listPharmacies){
        ...
        debug(`Insertion des ${listPharmacies.length} dans la base mongoDB.`);
